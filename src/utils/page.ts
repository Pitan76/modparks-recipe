  ...
  function App() {
    ...
    return e(Container, { maxWidth: 'md', sx: { py: 6 } },
      ...
      e(Typography, { color: 'text.secondary', sx: { mb: 3 } },
        'アイテムを一覧から選ぶか、ID（例: minecraft:iron_ingot）を入力してレシピを表示します。複数レシピがある場合はすべて表示されます。'),

      e('form', { onSubmit: openTyped },
        e(Stack, { direction: { xs: 'column', sm: 'row' }, spacing: 1.5, sx: { mb: 2 } },
          e(TextField, { label: '検索 / ID入力', placeholder: 'iron_ingot', value: q, onChange: function (x) { setQ(x.target.value); }, autoFocus: true, fullWidth: true }),
