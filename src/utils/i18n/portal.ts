...
const JA = {
  ...
  previewLocalFailed: 'この端末では作成できませんでした。サーバーで作成できます。',
  previewPng: 'PNGに変換して保存',
...
const EN: Messages = {
  ...
  upload: 'Upload',
  uploading: 'Uploading…',
  preview: 'Preview on the server',
  previewLocal: 'Rendering locally… {done} / {total}',
  previewLocalFailed: 'Could not render locally. You can render on the server instead.',
  previewPng: 'Save as PNG',
