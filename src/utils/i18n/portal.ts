...
const JA = {
  ...
  errorNamespaceLimit: '登録できるネームスペースの上限に達しました。',
...
const EN: Messages = {
  ...
  errorNamespaceLimit: 'Namespace limit reached.',
